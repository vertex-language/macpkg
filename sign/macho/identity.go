...
func LoadIdentityPEM(certPath, keyPath string) (*Identity, error) {
	...
	return LoadIdentityPEMFromBytes(certPEM, keyPEM)
}

// LoadIdentityPEMFromBytes parses a leaf cert (+ optional intermediates) and private key from PEM bytes.
func LoadIdentityPEMFromBytes(certPEM, keyPEM []byte) (*Identity, error) {
